            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="bg-portfolio-navy-light rounded-2xl p-8 shadow-portfolio-card">
                <form className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-portfolio-white font-medium mb-2">
                      Your Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-portfolio-white font-medium mb-2">
                      Your Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-portfolio-white font-medium mb-2">
                      Subject
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-portfolio-white font-medium mb-2">
                      Your Message
                    </label>
                    <textarea
                      id="message"
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-portfolio-gray leading-relaxed mb-8">
                    Ready to bring your ideas to life? Whether you have a project in mind or just want to chat about design, I'd love to hear from you. Let's create something amazing together!
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="flex items-center justify-center w-12 h-12 bg-portfolio-navy-light rounded-lg text-portfolio-gray hover:text-portfolio-orange hover:bg-portfolio-navy transition-all"
                    >
